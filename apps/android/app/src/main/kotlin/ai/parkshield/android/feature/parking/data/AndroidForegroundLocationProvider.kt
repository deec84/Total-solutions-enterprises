...
class AndroidForegroundLocationProvider(context: Context) : ForegroundLocationProvider {
    ...
    @SuppressLint("MissingPermission") override suspend fun current(): LocationState = suspendCancellableCoroutine { continuation ->
        ...
        manager.getCurrentLocation(provider, null, context.mainExecutor) { location: Location? ->
